...
public class BaseRunnerTest {
    ...
    @Parameters({"platformName", "deviceUDID", "deviceName", "systemPort",
            "chromeDriverPort", "wdaLocalPort", "webkitDebugProxyPort"})
    @BeforeClass(alwaysRun = true)
    public void setUpClass(String platformName, String deviceUDID, String deviceName, @Optional("Android") String systemPort,
