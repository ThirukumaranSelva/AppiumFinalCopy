    ...
    public void initializeDriver() throws Exception {
        ...
        try {
            ...
            switch (globalParams.getPlatformName()) {
                case "Android":
                    driver4 = new AndroidDriver(serverManager.getServer().getUrl(), capabilitiesManager.getDesiredCapabilities());
                    break;
                case "iOS":
                    driver4 = new IOSDriver(serverManager.getServer().getUrl(), capabilitiesManager.getDesiredCapabilities());
                    break;
            }
            if (driver4 == null) {
